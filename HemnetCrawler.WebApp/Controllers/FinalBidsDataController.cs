...
namespace HemnetCrawler.WebApp.Controllers
{
    ...
    public class FinalBidsDataController : ControllerBase
    {
        ...
        [HttpGet("finalBids")]
        public ItemsPage<FinalBidOutputModel> GetFinalBids(int pageIndex, int size, [FromQuery] FinalBidsFilterInputModel filter, SortDirection sortDirection, string orderByProperty)
        {
            return _fetchFinalBids.ListFinalBids(pageIndex, size, filter, sortDirection, orderByProperty);
        }
